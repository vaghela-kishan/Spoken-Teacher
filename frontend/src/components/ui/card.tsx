  ...
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        "shadow-[0_8px_28px_-16px_rgba(2,6,23,0.25)] dark:shadow-[0_16px_44px_-22px_rgba(0,0,0,0.75)]",
        className,
      )}
      {...props}
    />
  ...
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        "shadow-[0_10px_34px_-14px_rgba(2,6,23,0.28)] dark:shadow-[0_20px_50px_-24px_rgba(0,0,0,0.85)]",
        className,
      )}
      {...props}
    />
